      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const TextField(decoration: InputDecoration(labelText: 'Фамилия')),
            const SizedBox(height: 16),
            const TextField(
            ...
            const SizedBox(height: 16),
            const TextField(decoration: InputDecoration(labelText: 'Кабинет')),
            const SizedBox(height: 16),
            const TextField(decoration: InputDecoration(labelText: 'Дата рождения (YYYY-MM-DD)')),
            const SizedBox(height: 16),
            const TextField(decoration: InputDecoration(labelText: 'Отдел')),
            const SizedBox(height: 16),
            const TextField(decoration: InputDecoration(labelText: 'Интересы (через запятую)')),
            const SizedBox(height: 16),
            const TextField(decoration: InputDecoration(labelText: 'Класс')),
            const SizedBox(height: 16),
            const TextField(decoration: InputDecoration(labelText: 'Дата начала работы (YYYY-MM-DD)')),
            const SizedBox(height: 16),
            const TextField(
